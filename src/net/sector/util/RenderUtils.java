...
public class RenderUtils {
	 ...
	 */
	public static void quadRectBorder(Rect rect, double border, RGB borderColor, RGB insideColor) {
	 ...
	 */
	public static void quadRectGradV(Rect rect, RGB colorTop, RGB colorBottom) {
	 ...
	 */
	public static void quadRectGradVBilinear(Rect rect, RGB colorOuter, RGB colorMiddle) {
	 ...
	 */
	public static void quadRectGradHBilinear(Rect rect, RGB colorOuter, RGB colorMiddle) {
	 ...
	 */
	public static void quadRectGradH(Rect rect, RGB colorLeft, RGB colorRight) {
	...
	/**
	 * Render textured rect (texture must be binded beforehand)
	 * 
	 * @param quad rect descriptor
	 * @param textures texture coords
	 */
	public static void quadRectTextured(Rect quad, Rect textures) {
		double left = quad.x1();
		double bottom = quad.y1();
		double right = quad.x2();
		double top = quad.y2();

		double tleft = textures.x1();
		double tbottom = textures.y1();
		double tright = textures.x2();
		double ttop = textures.y2();
...
//	/**
//	 * Render quad 2D (coords from screen top)
//	 * 
//	 * @param left units from left
//	 * @param top units from bottom
//	 * @param width quad width
//	 * @param height quad height
//	 */
//	public static void quadTop(double left, double top, double width, double height) {
//		double bottom = App.inst.getSize().y - top - height;
//		quadSize(left, bottom, width, height);
//	}
//
//	/**
//	 * Render quad 2D with gradient vertical (coords from screen top)
//	 * 
//	 * @param left units from left
//	 * @param top units from bottom
//	 * @param width quad width
...
//	 * @param colorBottom bottom color
//	 */
//	public static void quadTopGradV(double left, double top, double width, double height, RGB colorTop, RGB colorBottom) {
//		double bottom = App.inst.getSize().y - top - height;
//		quadGradV(left, bottom, width, height, colorTop, colorBottom);
//	}
//
//	/**
//	 * Render quad 2D with gradient horizontal (coords from screen top)
//	 * 
//	 * @param left units from left
//	 * @param top units from bottom
//	 * @param width quad width
...
//	 * @param colorRight color right
//	 */
//	public static void quadTopGradH(double left, double top, double width, double height, RGB colorLeft, RGB colorRight) {
//		double bottom = App.inst.getSize().y - top - height;
