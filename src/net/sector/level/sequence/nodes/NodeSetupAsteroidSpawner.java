...
import net.sector.level.spawners.AsteroidSpawner;
...
public class NodeSetupAsteroidSpawner extends LevelNodeBase {
	 ...
	 */
	public NodeSetupAsteroidSpawner(LevelNodeBase parent, LevelController level) {
		super(parent, level);
	}
	...
	public boolean execute() {
		...
		SpawnerBase spawner = new AsteroidSpawner(getScene());
